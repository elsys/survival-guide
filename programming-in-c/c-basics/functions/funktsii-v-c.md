...
Получаваме този warning когато компилираме:
...
В случая е необходимо да напишем декларация.
...
```c
return_type function_name(type1 argname1, type2 argname2); // argument names are optional
```
...
1. Разгледайте какви аргументи приемат и какво връщат стандартните функции
   ...
   2. fgets
   3. strncpy
2. Напишете програма, която има в себе си деление на 0. Каква грешка ще получите и кога – при компилация или при пускане на програмата?
